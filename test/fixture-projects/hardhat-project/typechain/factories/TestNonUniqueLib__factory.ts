...
import type { TestNonUniqueLib } from "../TestNonUniqueLib";
...
export class TestNonUniqueLib__factory extends ContractFactory {
  ...
  static linkBytecode(
    ...
    linkedBytecode = linkedBytecode.replace(
      ...
      linkLibraryAddresses["__$093617208da6c0a6ce8b246e275858dc06$__"]
        .replace(/^0x/, "")
        .toLowerCase()
    );
...
export interface TestNonUniqueLibLibraryAddresses {
  ["__$093617208da6c0a6ce8b246e275858dc06$__"]: string;
}
